...
const styles = StyleSheet.create({
  ...
  debtSide: { alignItems: 'center', flex: 1 },
  debtSideRight: { alignItems: 'center' },
  debtName: { fontSize: 14, fontWeight: '600', color: COLORS.text, marginTop: 6 },
  debtCenter: { alignItems: 'center', flex: 1, paddingHorizontal: 8 },
  owesLabel: {
    fontSize: 11,
    color: COLORS.textSecondary,
    textTransform: 'uppercase',
  ...
  debtAmount: { fontSize: 18, fontWeight: '800', color: COLORS.danger, marginVertical: 2 },
